...
ADVANCED_AUTOMATED_DAMPENING_ADAPTIVE_MODEL_MINIMUM_MAPE_IMPROVEMENT: Final[str] = "automated_dampening_adaptive_model_minimum_mape_improvement"
ADVANCED_AUTOMATED_DAMPENING_ADAPTIVE_MODEL_MINIMUM_UNDAMPENED_ACTUAL: Final[str] = "automated_dampening_adaptive_model_minimum_undampened_actual"
...
DEFAULT_DAMPENING_ADAPTIVE_MODEL_MINIMUM_MAPE_IMPROVEMENT: Final[float] = 0.0 # Default to switching to adaptive model regardless of MAPE improvement
...
ADVANCED_OPTIONS: Final[dict[str, dict[str, Any]]] = {
    ...
    ADVANCED_AUTOMATED_DAMPENING_ADAPTIVE_MODEL_MINIMUM_MAPE_IMPROVEMENT: {
        ...
        MINIMUM: 0.0,
        MAXIMUM: 10.0,
        DEFAULT: DEFAULT_DAMPENING_ADAPTIVE_MODEL_MINIMUM_UNDAMPENED_ACTUAL,
        OPTION_REQUIRES: [ADVANCED_AUTOMATED_DAMPENING_ADAPTIVE_MODEL_CONFIGURATION]
    },
